...
<div class="container" style="margin-top: 120px;" >
  <div class="row w-100">
    <div class="col-3">
      ...
      <li class="nav-item">
        <a class="nav-link" id="v-tabs-messages-tab" data-mdb-toggle="tab" href="#v-tabs-messages" role="tab" aria-controls="v-tabs-messages" aria-selected="false">
          Manage Users</a>
      </li>
      </ul>
      </div>
    ...
    <div class="col-md-8 offset-md-2 mt-5">
      ...
      <form id="add-question-form">
        ...
        <div class="form-outline flex-fill mb-0 mt-5">
            <input type="text" id="answer-a" class="form-control"  required/>
            <label class="form-label" for="answer-a">Choice A</label>
        </div>
        <div class="form-outline flex-fill mb-0 mt-5">
            <input type="text" id="answer-b" class="form-control"  required/>
            <label class="form-label" for="answer-b">Choice B</label>
        </div>
        <div class="form-outline flex-fill mb-0 mt-5">
            <input type="text" id="answer-c" class="form-control"  required/>
            <label class="form-label" for="answer-c">Choice C</label>
        </div>
        <div class="form-outline flex-fill mb-0 mt-5">
            <input type="text" id="answer-d" class="form-control"  required/>
            <label class="form-label" for="answer-d">Choice D</label>
        </div>
        
        <div class="form-group mt-5">
          <label for="correct-answer">Correct Answer:</label>
          <select class="form-control" id="correct-answer">
        ...
        <button type="submit" name="addQuestion" class="btn btn-primary mt-5">Add Question</button>
      </form>
    </div>
  </div>
</div>
