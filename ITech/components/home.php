...
<div class="container">
  <div class="row">
    <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
      ...
      <a class="btn-get-started btn btn-primary" data-toggle="modal" data-target="#attentionModal">GET STARTED</a>
        <script>
          function () {
          // Load up a new modal...
...
<!-- Modal -->
<div class="modal fade" id="attentionModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <section class="px-md-5 mx-md-5 text-center dark-grey-text">
      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-xl-6 col-md-8">
          ...
          <p class="text-muted">Let us recommend the right program for you, so you can focus on what you do best!</p>

          <a class="btn btn-primary btn-md ml-0 mb-5" href="#" role="button"  data-dismiss="modal" >Start now<i class="fa fa-magic ml-2"></i></a>
