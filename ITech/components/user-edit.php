...
<nav class="navbar navbar-dark bg-dark navbar-expand-xxl shadow ">
  <div class="container">
        <a class="navbar-brand d-inline-block align-text-top " style ="padding-left: 1vw" href="user-management.php"><img src="../img/UCC.png"  id="navLogo"></a>
         Program Recommendation System<br>for University of Caloocan City

        <button class="navbar-toggler ms-auto"  style="margin-right: 25px; margin-left: 25px; " type="button" data-bs-toggle="collapse" data-bs-target="#collapseNavbar">
