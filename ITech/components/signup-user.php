                ...
                <form class="needs-validation mx-1 mx-md-4" action="signup-user.php" method="POST" autocomplete="" >
                 ...
                 <br>
                  <div class="form-check d-flex justify-content-center mb-5">
                    <input class="form-check-input me-2" type="checkbox" value="" id="termsofService" />
                    <label class="form-check-label " for="form2Example3">
                      By continuing, you have read and agree to the
                       <a data-mdb-toggle="modal" data-mdb-target="#disclaimerModal" href="" onclick="tickCheckbox()">Terms of service</a>
                    </label>
                  </div>
...
<script type="text/javascript" src="components_js/signup.js"></script>
<script>
