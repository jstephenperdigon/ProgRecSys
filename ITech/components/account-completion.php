               ...
               <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="address" name="address" class="form-control" placeholder="House No. or Lot No. / Road / Street /" value="" />
                        </div>
                        <div class="form-group">
                            <input type="text"  id="barangay" name="barangay" class="form-control" placeholder="Barangay " value="" />
                        </div>
                        <div class="form-group">
                            <input type="text"  id="zip" name="zip" class="form-control" placeholder="ZIP / Postal Code " value="" />
                        </div>
                        <!-- UPLOAD FILE
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="address" name="addressline2" class="form-control" placeholder="Apartment, Suite , Unit, Bldg, floor, etc." value="" />
                        </div>
                        <div class="form-group">
