...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline justify-content-center my-2 my-lg-0">
        <button type="button" class="btn justify-content-center my-2 my-sm-0" style="box-shadow: none;" data-toggle="modal" data-target="#loginModal">
       SIGN IN
...
<?php
    ...
    <div class="modal-content" style="border-radius: 20px;">
      ...
      <div class="modal-body">
        ...
        <div class="d-flex flex-column text-center">
          ...
          type="submit" class="btn btn-primary btn-block mb-4 mt-2"><i class="fa-brands fa-google"></i>  SIGN IN WITH GOOGLE</button>
        </div>
        <hr class="hr" /> OR 
        </div>
        <div class="d-flex flex-column text-center">
  ...
  <div class="form-outline input-group mb-4">
    <input type="password" id="loginpass" class="form-control" name="password" value="<?php echo $pass?>" required />
  ...
  <div class="row mb-4">
    <div class="col d-flex justify-content-center">
      ...
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="" id="form2Example31" name="remember_me" checked />
    ...
    <div class="col">
      <!-- Simple link -->
      <a href="#!" data-target="#pwdModal" data-toggle="modal" data-dismiss="modal" onClick="$('#loginModal').modal('hide')">Forgot password?</a>
      <script>
  ...
  <!-- Submit button -->
  <button type="submit" name="login" onclick="return myFunction()" class="btn btn-primary btn-block mb-4">Sign in</button>
  <!-- Register buttons -->
      ...
      <div class="modal-body">
        <form action="index.php" method="POST" autocomplete="">
          <div class="form-floating mb-3">
            <input type="email" class="form-control" id="forgotPasswordEmail" name="email" placeholder="Email" autofocus required>
            <label for="forgotPasswordEmail">Email Address</label>
          </div>
        
        
      
        <button type="button" class="btn btn-secondary" data-dismiss="modal" data-target="#loginModal" data-toggle="modal" aria-hidden="true">Close</button>
