                ...
                <div class="form-content shadow" style="border-radius: 50px;">
                    <div class="form-items">
                        ...
                        <form action="new-password.php" method="post" class="requires-validation" id="passwordForm" novalidate>
                           <div class="col-md-12">
                              <input class="form-control" type="password" name="password1" id="password1" placeholder="New Password" required>
                              <div class="row">
                                <div class="col-sm-6">
                           ...
                           <div class="col-md-12">
                              <input class="form-control" type="password" name="password2" id="password2" placeholder="Password Confirmation" required>
                              <div class="row">
                                  <div class="col-sm-12">
                            ...
                            <div class="form-button mt-4">
                                <button id="submit" type="submit"  name="change-password" class="btn btn-primary">CHANGE PASSWORD</button>
                            </div>
                        </form>
                    </div>
                </div>
